...
export const BarrierCam: React.FC<BarrierCamProps> = ({ appState, onTrigger, settings, onSettingsChange, addLog }) => {
    ...
    >
      ...
      <div className="absolute top-4 left-4 z-20 flex gap-2">
        <button
          ...
          className="bg-black/50 hover:bg-black/80 backdrop-blur-md p-2 rounded-full text-white transition-all border border-white/10"
