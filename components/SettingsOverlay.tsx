...
export const SettingsOverlay: React.FC<SettingsOverlayProps> = ({
  ...
  return (
    <>
      {/* Backdrop */}
      <div
        className="fixed inset-0 bg-gray-950/90 backdrop-blur-sm z-40 animate-in fade-in duration-200"
        onClick={onClose}
      />

      {/* Overlay Panel */}
      <div className="fixed inset-3 md:inset-auto md:top-1/2 md:left-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:w-[400px] md:max-h-[85vh] z-50 animate-in slide-in-from-bottom-4 fade-in duration-300">
        <div className="bg-gray-900 rounded-xl border border-blue-800/40 shadow-2xl shadow-blue-950/50 flex flex-col max-h-full">
          {/* Header */}
          <div className="flex items-center justify-between p-4 border-b border-blue-800/30 shrink-0">
            ...
            <button
              onClick={onClose}
              className="text-blue-400 hover:text-white transition-colors p-2 hover:bg-blue-900/50 rounded-lg"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 20 20"
          ...
          {/* Footer */}
          <div className="p-4 border-t border-blue-800/30 shrink-0">
            <button
              onClick={onClose}
              className="w-full bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-500 hover:to-cyan-500 text-white font-bold py-3 px-6 rounded-lg transition-all transform active:scale-[0.98] shadow-lg shadow-blue-900/50 border border-blue-400/20 text-sm"
            >
              Done
            </button>
          </div>
